...
int tempPin = A2;                 // Sensor de temperatura en la entrada analogica 2
int blinkPin = 13;                // pin to blink led at each beat
int fadePin = 5;                  // pin to do fancy classy fading blink at each beat
int fadeRate = 0;                 // used to fade LED on with PWM on fadePin
int btnEstado = 0;                // Estado inicial del boton de pausa
float tempC;                      // Variable para el valor que lea el sensor de temperatura
const int chipSelect = 4;         // Pin de ChipSelect indispensable para el lector SD
int botonPin = 8;                 // Pin donde leera el boton de pausa
/////////////////////////////////////////////////////////////////////////////////////////////////////
...
void setup()
{
  ...
  pinMode(3,OUTPUT);                // Led que indica si el lector SD esta en uso
